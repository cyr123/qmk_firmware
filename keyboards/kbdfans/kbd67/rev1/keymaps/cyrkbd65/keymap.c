...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT_all(
        ...
        MO(_FUNC), KC_A,   KC_S,   KC_D,   KC_F,   KC_G,   KC_H,   KC_J,   KC_K,    KC_L,    KC_SCLN, KC_QUOT,    KC_ENT,             KC_PGDN, 
     ...
     * |----------------------------------------------------------------|
     * |Caps |Hom|Up |End|PgU|   |   |   |   |   |Prt|SLk|Pau|     |Home|
     * |------------------------------------------------------.    |----|
     * |      |Lef|Dow|Rig|PgD|   |   |   |   |   |   |   |   |    |End |
     * |----------------------------------------------------------------|
     * |       |   |   |   |    |   |   |   |Prv|PlP|Nxt|      |PUp|    |
    ...
    [_FUNC] = LAYOUT_all(
         ...
         KC_CAPS,   KC_HOME, KC_UP, KC_END, KC_PGUP, _______,_______,_______,_______,_______,KC_PSCR,KC_SLCK,KC_PAUS,_______,      KC_HOME, 
